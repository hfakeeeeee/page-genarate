...
class ProjectManagerService:
    ...
    async def package_project(
        ...
        await self._copy_base_project(project_plan.framework,
                                      project_plan.language,
                                      project_dir)
        ...
        with open(project_dir / "project-info.json", "w",
                  encoding="utf-8") as f:
            ...
            if project_dir.is_dir():
                ...
                if info_file.exists():
                    try:
                        ...
                        print(f"Error reading project info for "
    ...
    async def _copy_base_project(self, framework: str,
                                 language: str,
                                 destination: Path):
